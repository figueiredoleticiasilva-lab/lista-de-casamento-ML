...
<title>Marcos & Letícia | Lista de Presentes</title>

<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>

<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600&family=DM+Sans:wght@400;500;600&family=Parisienne&display=swap" rel="stylesheet">
...
.hero {
    ...
    background:
        radial-gradient(
            circle at 10% 20%,
            rgba(201,151,155,0.10),
            transparent 28%
        ),
        radial-gradient(
            circle at 90% 75%,
            rgba(170,184,161,0.13),
            transparent 28%
        ),
        var(--fundo);
...
.special-card {
    ...
    border: 1px solid rgba(180,160,145,.35);
...
<header class="hero">
    ...
    <div class="hero-content">
        ...
        <p class="hero-text">
            Estamos construindo nosso lar com muito carinho
            e preparamos esta lista para quem deseja fazer
            parte desse momento tão especial da nossa história.
        </p>

        <a href="#lista" class="hero-button">
            Ver nossa lista
        </a>
...
<section class="intro" id="lista">
    ...
    <p>
        Cada presente escolhido fará parte da construção
        do nosso lar. Para facilitar, basta clicar em
        <strong>“Ver presente”</strong> para conferir o produto.
    </p>
...
<section class="category" id="cozinha">
    ...
    <div class="grid">
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://www.mercadolivre.com.br/social/leticiafigueiredo56?matt_word=leticiafigueiredo56&matt_tool=58083210&forceInApp=true&ref=BLcb%2BoDsjuc4q%2F%2BA8y6NlSJWL%2FfkHRclETjYmyMA%2Fg1ZgQ40JxYW%2B6zynt%2FuFnOn3VntuGvMJTQyHcX%2FmhEAhDj7a11FJ6kj3RPtie3in8S1ukLIzrWW%2BAo72iU%2FrWrpnVu59VR%2BnzDXYkEpxnzgeHUq0ilHeCzN5qdeSoX0UPj2YkCVVdW6Z3ycLflqvv%2BAD%2B%2BBhy2xFUDpKoDfnMkvNfciAn5mmVnt5iI7aqiteMMtEGAT#origin=whatsapp"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://www.mercadolivre.com.br/social/leticiafigueiredo56?matt_word=leticiafigueiredo56&matt_tool=58083210&forceInApp=true&ref=BETY9waiansfy9FRTfEXBPd2ZfMh35xP%2FhrpLNnwmgSKCLnxzDafyAY8DmTW7nA%2Fv1rrztCDHTDHgPNWxwKBEohd7LPFWr5oZYsw%2FQPNe9vvcDkugAvdEnDBtV72b%2FX7%2FXIlIY%2BFuBjF0oF1jIZWyYz%2F0abeAUvnwJTG8fwZQkgp90a%2B3wX4cfjcCtvkpzhhPhOEHl2LQJRUcvOS7j22VmKAEwRp7s9RWpoOSi8%2Bcu25TEynSA%3D%3D#origin=whatsapp"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://www.mercadolivre.com.br/social/leticiafigueiredo56?matt_word=leticiafigueiredo56&matt_tool=58083210&forceInApp=true&ref=BC0jNBhpmMpG%2BRb8MUc9npQPndUulFpUiRDxeOY13HKOSiPT7SVueeTu%2BB3Kvebdxk9LOBj6949FUDz%2ByUwmK0RwgAzW58Xb3o8kUV%2F4AfmPNLab3%2BdEQGV8bXiWsA4X0fdWWM%2FJK%2F0BXFK1hpAClYO%2FgQzv8SCfSdEEqGv%2FsxEk0a7y2bNQ2CxV0z9cZvQojp9buBdFzzcFm1aoCYxsRtxZyqThCgcmAoTRzjbGfXk%3D#origin=whatsapp"
               target="_blank">
               Ver presente
            </a>
        </article>
...
<section class="category" id="quarto">
    ...
    <div class="grid">
        ...
        <article class="card">
            <div>
                <h3>Kit Tapete de banheiro | cor areia</h3>
                <div class="price">R$ 51,89</div>
            </div>

            <a class="button"
               href="https://shopee.com.br/product/1551841162/58257503731?d_id=2617a&uls_trackid=56djkjl800jo&utm_content=3TR3zAGztpvcHuxbgCUyumwEfHFM"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://www.mercadolivre.com.br/social/leticiafigueiredo56?matt_word=leticiafigueiredo56&matt_tool=58083210&forceInApp=true&ref=BAN7BBlHDSESfqzqxzfqTper7pAU%2FyEqdE8sJD2qYgFRSpBtM0UC2rWFH%2Bsq7YfD0if91bgoP0NVwyfmwieHLUG9g177I2UV5LDEj9GtvYSGmV5ioxEJBESJSESp80NNSfXoaf7sIMRCzMLOpeRE29l8nOV4ciredm88XOmLfXr6yCDgqRQowRqoJsnW264nR2saA%3D%3D#origin=whatsapp"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            <div>
                <h3>Jogo de Lençol | Queen Size | Azul</h3>
        ...
        <article class="card">
            <div>
                <h3>Jogo de Lençol | Queen Size | Branco</h3>
                <div class="price">R$ 196,90</div>
            </div>
...
<section class="category" id="organizacao">

    <div class="section-title">
        <h2>Organização & Limpeza</h2>
    </div>
    ...
    <div class="grid">
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://shopee.com.br/product/1613200158/23194739322?d_id=2617a&uls_trackid=56dj8clj01ik&utm_content=3TR3zAGztkPLekBfLnL98RjVJDmq"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            <div>
                <h3>Cesto de Roupas | 72L</h3>
                <div class="price">R$ 64,18</div>
            </div>

            <a class="button"
               href="https://shopee.com.br/product/1202669405/22994876216?d_id=2617a&uls_trackid=56djkn2d00ic&utm_content=3TR3zAGztqBm7yu5AunFvwnWBNej"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            <div>
                <h3>Tábua de passar | Branco</h3>
                <div class="price">R$ 94,58</div>
            </div>

            <a class="button"
               href="https://shopee.com.br/product/828345931/58263697955?d_id=2617a&uls_trackid=56djkouj00r5&utm_content=3TR3zAGztqTm4g6DmWPPh2GRpgJs"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            <div>
                <h3>Varal de aço retrátil | 5 barras (200cm)</h3>
                <div class="price">R$ 141,55</div>
            </div>

            <a class="button"
               href="https://shopee.com.br/product/1479426364/57755015455?d_id=2617a&uls_trackid=56djkqmf00hl&utm_content=3TR3zAGztqdMaqxatRy5qosfNfnF"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://www.mercadolivre.com.br/social/leticiafigueiredo56?matt_word=leticiafigueiredo56&matt_tool=58083210&forceInApp=true&ref=BMrcK2IJHC6NBAu6qlrDMxOvp6ajoWaBw5HUn4b8LjiCzyWXg8CTYhXxcc13THo309fPSWAtDQjzw%2BQfzpGOGRtzV5Mwq8SKmIfSM%2BKZ6x6MdXEB0Rrvm%2Bn08FUgZeF23n%2BThdQW0cGeGUo%2FGeyn9TtqAtWx%2FDCqKTxRgYWjOjgxjJsLr4PAewQ66w%2FWX86VvagPXZjEjMBfwBfwmSOUKmSJKCn8X3tYzvjBttEDd3JmeIMY#origin=whatsapp"
               target="_blank">
               Ver presente
            </a>
        </article>
...
<section class="category" id="moveis">
    ...
    <div class="grid">
        ...
        <article class="card">
            <div>
                <h3>Gabinete Banheiro | Preto</h3>
                <div class="price">R$ 461,78</div>
            </div>

            <a class="button"
               href="https://shopee.com.br/product/522316174/23692582601?d_id=2617a&uls_trackid=56dj3ap400jl&utm_content=3TR3zAGzthfpP4LKbV1CzmqTTWMu"
               target="_blank">
               Ver presente
            </a>
        </article>
        ...
        <article class="card">
            ...
            <a class="button"
               href="https://shopee.com.br/product/1461950253/58212526901?d_id=2617a&uls_trackid=56dj37q101jl&utm_content=3TR3zAGztqBm7yu5AunFvwnWBNej"
               target="_blank">
               Ver presente
            </a>
        </article>
...
<section class="special-section" id="especiais">
    ...
    <p class="special-description">
        Alguns presentes fazem parte de sonhos maiores para
        nossa nova casa. Se você quiser nos presentear com
        um deles, ficaremos muito felizes em ter esse carinho
    ...
    <div class="special-grid">
        ...
        <article class="special-card">
            ...
            <a class="button"
               href="https://www.madeiramadeira.com.br/sofa-cama-retratil-e-reclinavel-dubai-tecido-linho-molas-ensacadas-1-90m-598946767.html?origem=pla-598946767&utm_source=google&utm_medium=cpc&utm_content=sofa-retratil-5142&utm_term=&utm_id=22811606548&gad_source=1&gad_campaignid=22811606548&gbraid=0AAAAADr4g_EnCBEJCJr1RNlqKg4s8TKF_&gclid=Cj0KCQjw-frTBhCvARIsADv4XY45BJ9nwCQVPAHjv-uhgqsMmQswduUfxNdC2gdB-dZi1hdaaxR15IaAtmnEALw_wcB"
               target="_blank">
               Ver presente
            </a>
...
<section class="final">
    ...
    <p>
        Mais importante do que qualquer presente é ter
        vocês conosco nesse dia tão especial.
        Cada gesto de carinho ficará guardado para sempre
        em nossos corações.
    </p>
...
<footer>
    ...
    Marcos & Letícia · Nossa Lista de Presentes
